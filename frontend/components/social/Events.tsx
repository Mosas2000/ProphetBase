...
export default function Events() {
  const [events, setEvents] = useState<Event[]>([
    {
      ...
      description:
        'Join our top trader for a live Q&A session. Learn advanced strategies, get your questions answered, and win prizes!',
      type: 'ama',
    ...
    },
    {
      ...
      description:
        '7-day trading competition with $10k prize pool. Open to all traders. Best profit percentage wins!',
    ...
    },
    {
      ...
      description:
        'Learn the basics of prediction markets, how to trade, and strategies for beginners.',
      type: 'webinar',
    ...
    },
    {
      ...
      description:
        'Advanced strategies for market makers. Learn how to provide liquidity and earn consistent returns.',
      type: 'webinar',
      date: new Date(Date.now() - 86400000).toISOString(),
      duration: 120,
      host: {
  ...
  const [filter, setFilter] = useState<'upcoming' | 'past' | 'registered'>(
    'upcoming'
  );
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600">
            Join webinars, AMAs, contests, and community gatherings
          </p>
        </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-2">
                  <span
                    className={`text-xs px-3 py-1 rounded-full capitalize ${getEventTypeColor(
                      event.type
                    )}`}
                  >
