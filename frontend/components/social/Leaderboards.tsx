...
export default function Leaderboards() {
  ...
  const [category, setCategory] = useState<'profit' | 'volume' | 'winrate' | 'creators' | 'accuracy' | 'streak'>('profit');

  const leaderboards = {
    profit: [
      {
        rank: 1,
        user: { address: '0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb', username: 'ProphetKing', avatar: '👑' },
        stats: { totalProfit: 45230, winRate: 72.5 },
        change: 2
      },
      {
        rank: 2,
        user: { address: '0x8626f6940E2eb28930eFb4CeF49B2d1F2C9C1199', username: 'WhaleTrader', avatar: '🐋' },
        stats: { totalProfit: 38950, winRate: 68.3 },
        change: -1
      },
      {
        rank: 3,
        user: { address: '0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0', username: 'DiamondHands', avatar: '💎' },
        stats: { totalProfit: 31450, winRate: 65.8 },
        change: 1
      },
      {
        rank: 4,
        user: { address: '0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9', username: 'SmartMoney', avatar: '🧠' },
        stats: { totalProfit: 28120, winRate: 70.2 },
        change: -2
      },
      {
        rank: 5,
        user: { address: '0x5FbDB2315678afecb367f032d93F642f64180aa3', username: 'RocketTrader', avatar: '🚀' },
    ...
    creators: [
      {
        rank: 1,
        user: { address: '0x5FbDB2315678afecb367f032d93F642f64180aa3', username: 'MarketMaker', avatar: '🏭' },
    ...
    accuracy: [
      {
        rank: 1,
        user: { address: '0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9', username: 'Oracle', avatar: '🔮' },
    ...
    streak: [
      {
        rank: 1,
        user: { address: '0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb', username: 'LuckyStreak', avatar: '🔥' },
    ...
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-5xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600">Top performers across all categories</p>
        </div>
      ...
      <div className="grid grid-cols-6 gap-2 mb-6">
        {(['profit', 'volume', 'winrate', 'creators', 'accuracy', 'streak'] as const).map(cat => (
          <button
            key={cat}
            ...
            <div className="flex items-center space-x-3 flex-1">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500 font-mono">
                  {entry.user.address.slice(0, 10)}...{entry.user.address.slice(-6)}
                </div>
              </div>
            </div>
