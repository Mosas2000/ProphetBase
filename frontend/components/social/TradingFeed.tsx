...
export default function TradingFeed() {
  ...
  const [filter, setFilter] = useState<'all' | 'trades' | 'markets' | 'whales'>(
    'all'
  );
  ...
  const filteredFeed = feed.filter((item) => {
    ...
    if (filter === 'markets')
      return item.type === 'market_created' || item.type === 'resolved';
              ...
              <div>
                ...
                <div className="ml-10 p-3 bg-white rounded border-l-4 border-purple-500">
                  ...
                  <p className="text-xs text-gray-500">
                    Market #{item.data.marketId} •{' '}
                    {item.data.shares.toLocaleString()} shares acquired
                  </p>
                </div>
              </div>
            )}
              ...
              <div>
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Added ${item.data.initialLiquidity.toLocaleString()}{' '}
                      initial liquidity
                    </p>
                  </div>
                  <span className="text-xs text-gray-500">
              ...
              <div>
                ...
                <div className="ml-10 p-3 bg-white rounded border-l-4 border-green-500">
                  ...
                  <div className="flex items-center space-x-4 text-xs text-gray-600">
                    <span>
                      💰 ${item.data.totalVolume.toLocaleString()} volume
                    </span>
