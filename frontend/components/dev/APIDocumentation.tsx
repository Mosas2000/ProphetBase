...
export default function APIDocumentation() {
  const [selectedCategory, setSelectedCategory] = useState<
    'markets' | 'trading' | 'user' | 'analytics'
  >('markets');
    ...
    analytics: [
      {
        ...
        response:
          '{ "volume": 125000, "traders": 847, "volatility": 18.5, ... }',
    ...
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-7xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600">
            RESTful API for ProphetBase integration
          </p>
        </div>
      ...
      <div className="mt-8 p-6 bg-blue-50 rounded-lg border-2 border-blue-200">
        ...
        <p className="text-gray-700 text-sm">
          ...
          <code className="text-blue-600">X-API-Key</code> header for
