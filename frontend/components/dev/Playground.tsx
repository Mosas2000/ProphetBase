...
export default function Playground() {
  ...
  const quickActions = [
    { label: 'Get Markets', endpoint: '/api/v1/markets', method: 'GET', params: '{\n  "limit": 10\n}' },
    { label: 'Get Market #42', endpoint: '/api/v1/markets/42', method: 'GET', params: '{}' },
    { label: 'Place Trade', endpoint: '/api/v1/trades', method: 'POST', params: '{\n  "marketId": "42",\n  "outcome": "YES",\n  "amount": 10\n}' },
    { label: 'User Profile', endpoint: '/api/v1/user/profile', method: 'GET', params: '{}' }
  ];
  ...
  const executeRequest = async () => {
    ...
    try {
      ...
      const mockResponse = {
        markets: [
          { id: '42', question: 'Will Bitcoin reach $100k by EOY?', volume: 125000 },
                  ...
                  className={`px-4 py-2 rounded font-medium text-sm transition-colors ${
                    method === m
                      ? m === 'GET' ? 'bg-green-600 text-white' :
                        ...
                        m === 'PUT' ? 'bg-yellow-600 text-white' :
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            {statusCode && (
              <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                ...
                statusCode >= 400 ? 'bg-red-100 text-red-700' :
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-lg">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="ml-2 font-semibold text-gray-900">247ms</span>
                </div>
                <div>
