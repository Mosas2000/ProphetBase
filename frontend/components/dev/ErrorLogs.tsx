            ...
            >
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center space-x-2">
                  ...
                  <code className="text-xs bg-gray-100 px-2 py-1 rounded">{log.code}</code>
                </div>
            ...
            <div className="border-2 border-gray-200 rounded-lg p-6 sticky top-0">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="mt-1">
                    <span className={`px-3 py-1 rounded font-semibold text-sm uppercase ${getLevelColor(selectedLog.level)}`}>
                      {selectedLog.level}
                    </span>
                  </div>
                </div>
                ...
                <div>
                  <label className="text-xs font-semibold text-gray-600 uppercase">Error Code</label>
                  <p className="mt-1 text-gray-900 font-mono">{selectedLog.code}</p>
                </div>

                <div>
                  <label className="text-xs font-semibold text-gray-600 uppercase">Timestamp</label>
                  <p className="mt-1 text-gray-900">{selectedLog.timestamp.toLocaleString()}</p>
                </div>
                ...
                <div>
                  <label className="text-xs font-semibold text-gray-600 uppercase">Endpoint</label>
                  <p className="mt-1 text-blue-600 font-mono text-sm">{selectedLog.endpoint}</p>
                </div>
                ...
                {selectedLog.stackTrace && (
                  <div>
                    <label className="text-xs font-semibold text-gray-600 uppercase mb-2 block">Stack Trace</label>
