    ...
    >
                ...
                >
                  ...
                  <td className="py-4 pr-4">
                    <div className="flex items-center gap-3">
                      <Jazzicon
                        seed={parseInt(entry.address.slice(2, 10), 16)}
                        diameter={32}
                      />
                      <div>
                  ...
                  <td className="py-4 pr-4 text-right">
                    <div>
                      <p
                        className={`text-sm font-semibold ${getWinRateColor(
                          entry.winRate
                        )}`}
                      >
      ...
      <div className="mt-6 rounded-lg bg-blue-50 p-3">
        <p className="text-xs text-blue-700">
          📊 <strong>Note:</strong> Leaderboard shows mock data. Real rankings
          will be calculated from on-chain activity.
        </p>
      </div>
    </div>
  );
