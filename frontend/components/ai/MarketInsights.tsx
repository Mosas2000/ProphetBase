...
export default function MarketInsights() {
  const [selectedCategory, setSelectedCategory] = useState<
    'all' | 'opportunity' | 'risk' | 'trend' | 'anomaly' | 'prediction'
  >('all');
  ...
  const [insights] = useState<Insight[]>([
    {
      ...
      summary:
        'Multiple crypto-related prediction markets showing synchronized bullish signals with institutional adoption indicators',
      analysis: [
      ...
      recommendation:
        'Consider increasing exposure to crypto-related markets. Target 35-40% portfolio allocation with stop losses at current support levels ($0.63-$0.65).',
      confidence: 87,
    ...
    },
    {
      ...
      summary:
        'AI detects increasing correlation between tech markets with heightened volatility risk',
      analysis: [
      ...
      recommendation:
        'Reduce concentration in correlated tech positions. Consider hedging with defensive sectors or taking partial profits on tech-heavy positions.',
      confidence: 82,
    ...
    },
    {
      ...
      summary:
        'Sustained volume increase and sentiment improvement in climate and sustainability markets',
      analysis: [
      ...
      recommendation:
        'Early-stage opportunity in climate markets. Consider 10-15% allocation as markets are still establishing price discovery.',
      confidence: 74,
    ...
    },
    {
      ...
      summary:
        'AI detects pricing inefficiency between related inflation prediction markets',
      analysis: [
      ...
      recommendation:
        'Arbitrage strategy: Long underpriced market, short overpriced market. Risk-adjusted return 7-9% with 2-3 week holding period.',
      confidence: 91,
    ...
    },
    {
      ...
      summary:
        'AI models detect multiple signals suggesting broader market correction risk',
      analysis: [
      ...
      recommendation:
        'Defensive positioning recommended. Reduce leverage, tighten stop losses, and increase cash allocation to 20-25%.',
      confidence: 78,
      potentialImpact:
        'Potential 10-20% portfolio drawdown if correction occurs',
      timeframe: '5-10 days',
    ...
    },
    {
      ...
      summary:
        'Gradual accumulation pattern detected in healthcare-related markets',
      analysis: [
      ...
      recommendation:
        'Early accumulation opportunity. Small 5-10% position could grow as trend develops.',
      confidence: 68,
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-slate-400">
                AI-generated market analysis and opportunities
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className="flex items-start gap-3 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span
                          className={`px-3 py-1 rounded-lg text-xs font-semibold ${getPriorityColor(
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-slate-700/50 rounded-lg p-4">
                    ...
                    <div className="text-lg font-semibold text-green-400">
                      {selectedInsight.potentialImpact}
                    </div>
                  </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-slate-300">
                These insights are generated by analyzing millions of data
                points including price movements, volume patterns, sentiment
                indicators, and macroeconomic factors. Use them as one input in
