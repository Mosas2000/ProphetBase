    ...
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-7xl">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">
          Auto-compounding vaults with optimized strategies
        </p>
      </div>
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-semibold border-2 ${getRiskColor(
                      vault.riskLevel
                    )}`}
                  >
                ...
                <div className="grid grid-cols-5 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <div className="font-semibold text-blue-600">
                      ${vault.myDeposit.toLocaleString()}
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-3 gap-3 mb-4 text-sm">
                  <div className="p-3 bg-green-50 rounded">
                    ...
                    <div className="font-bold text-green-600">
                      $
                      {(
                        ((vault.myDeposit * vault.apy) / 100 / 365) *
                        30
                      ).toFixed(2)}
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4">
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={`font-semibold ${
                    selectedVault.riskLevel === 'Low'
                      ? 'text-green-600'
                      : selectedVault.riskLevel === 'Medium'
                      ? 'text-yellow-600'
                      : 'text-red-600'
                  }`}
                >
              ...
              {depositAmount && (
                <div className="flex justify-between pt-2 border-t">
                  ...
                  <span className="font-bold text-blue-600">
                    $
                    {(
                      (parseFloat(depositAmount) * selectedVault.apy) /
                      100 /
                      12
                    ).toFixed(2)}
                  </span>
